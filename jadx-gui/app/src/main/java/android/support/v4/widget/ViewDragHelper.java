                    ...
                    while (true) {
                        if (i2 < pointerCount2) {
                            ...
                            if (pointerId5 != this.mActivePointerId) {
                                i = (findTopChildUnder((int) MotionEventCompat.getX(motionEvent, i2), (int) MotionEventCompat.getY(motionEvent, i2)) == this.mCapturedView && tryCaptureViewForDrag(this.mCapturedView, pointerId5)) ? this.mActivePointerId : -1;
                            }
                            i2++;
                        }
                    }
