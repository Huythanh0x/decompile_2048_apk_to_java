...
public class AlertController {
    ...
    private void setupView() {
        ...
        int i = (resolvePanel == null || resolvePanel.getVisibility() == 8) ? 0 : 1;
        ...
        if (!z) {
            ...
            if (view != null) {
                setScrollIndicators(resolvePanel2, view, i | (z2 ? 2 : 0), 3);
            }
        }
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (this.mCursor != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(this.mContext, i, this.mCursor, new String[]{this.mLabelColumn}, new int[]{android.R.id.text1});
                } else if (this.mAdapter != null) {
                    checkedItemAdapter = this.mAdapter;
                } else {
                    checkedItemAdapter = new CheckedItemAdapter(this.mContext, i, android.R.id.text1, this.mItems);
                }
            }
