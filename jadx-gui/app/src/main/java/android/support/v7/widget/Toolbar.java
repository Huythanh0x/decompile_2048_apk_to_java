...
public class Toolbar extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            i5 = ViewUtils.combineMeasuredStates(0, ViewCompat.getMeasuredState(this.mNavButtonView));
        } else {
            i3 = 0;
            i4 = 0;
            i5 = 0;
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            i5 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(this.mCollapseButtonView));
        }
        int contentInsetStart = getContentInsetStart();
        int max = Math.max(contentInsetStart, i3) + 0;
        iArr[c] = Math.max(0, contentInsetStart - i3);
        if (shouldLayout(this.mMenuView)) {
            ...
            i5 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(this.mMenuView));
        } else {
            i6 = 0;
        }
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            ...
            i5 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(this.mExpandedActionView));
        }
        if (shouldLayout(this.mLogoView)) {
            ...
            i5 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(this.mLogoView));
        }
        int childCount = getChildCount();
        int i10 = i4;
        int i11 = max2;
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                ...
                i5 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(childAt));
            }
        }
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            i7 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(this.mTitleTextView));
            i8 = measuredWidth;
        } else {
            i7 = i5;
            i8 = 0;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            ...
            i7 = ViewUtils.combineMeasuredStates(i7, ViewCompat.getMeasuredState(this.mSubtitleTextView));
        }
